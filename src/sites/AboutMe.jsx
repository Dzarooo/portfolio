            ...
            <div className="rounded-xl flex gap-10">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="bg-slate-800 p-2 rounded-full flex gap-2 justify-center items-center">
                        <a href="https://github.com/Dzarooo" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" className="fill-slate-100 hover:fill-purple-400 transition-colors">
                        ...
                        <a href="#" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 hover:fill-purple-400 transition-colors">
                        ...
                        <a href="https://www.facebook.com/kacper.jaroszewski.7792/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 hover:fill-purple-400 transition-colors">
                        ...
                        <a href="https://www.instagram.com/czare.ek/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 hover:fill-purple-400 transition-colors">
                ...
                <div className="bg-black/25 p-4 rounded-xl text-slate-100 border-2 border-slate-100 w-[600px]">
                    <h1 className="text-3xl border-b-2 border-b-slate-100 pb-2">I'm <span className="text-purple-300">Kacper Jaroszewski</span>, passionate about programming.</h1>
                    <p className="pt-2 text-xl">I started learning programming in 2021, and since then i work hard to improve my skills. I focus on web development, working as full-stack, but mainly on frontend. I made websites in <span className="text-purple-300">plain HTML/CSS/JS</span>, <span className="text-purple-300">React</span>, <span className="text-purple-300">Vue</span>, <span className="text-purple-300">Express.js</span> and <span className="text-purple-300">Laravel</span>. I'm familiar <span className="text-purple-300">MongoDB</span> for database.</p>
                    <p className="pt-2 text-xl">I'm also familiar with Unity, where i made a card game.</p>
                </div>
            </div>
        </div>
    )
