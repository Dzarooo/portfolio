            ...
            <div className="border-2 border-slate-100 p-2 rounded-xl flex bg-black/25 w-[1000px] h-[500px]">
                ...
                <div className="flex-2/3 flex flex-col justify-center gap-2 p-5">
                    <a href="https://github.com/Dzarooo" target="_blank" className="flex gap-2 items-center group hover:translate-x-2 transition-transform">
                        ...
                        <span className="text-slate-100 text-xl group-hover:text-purple-300 transition-colors">https://github.com/Dzarooo</span>
                    </a>
                    <a href="#" target="_blank" className="flex gap-2 items-center group hover:translate-x-2 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 group-hover:fill-purple-300 transition-colors">
                        ...
                        <span className="text-slate-100 text-xl group-hover:text-purple-300 transition-colors">https://linked.in/Dzarooo</span>
                    </a>
                    <a href="https://www.facebook.com/kacper.jaroszewski.7792/" target="_blank" className="flex gap-2 items-center group hover:translate-x-2 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 group-hover:fill-purple-300 transition-colors">
                        ...
                        <span className="text-slate-100 text-xl group-hover:text-purple-300 transition-colors">https://www.facebook.com/kacper.jaroszewski.7792/</span>
                    </a>
                    <a href="https://www.instagram.com/czare.ek/" target="_blank" className="flex gap-2 items-center group hover:translate-x-2 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 24 24" className="fill-slate-100 group-hover:fill-purple-300 transition-colors">
                        ...
                        <span className="text-slate-100 text-xl group-hover:text-purple-300 transition-colors">https://www.instagram.com/czare.ek/</span>
                    </a>
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kacperjaroszewski06@gmail.com" target="_blank" className="ml-1 flex gap-3 items-center group hover:translate-x-2 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 50 50" className="fill-slate-100 group-hover:fill-purple-300 transition-colors">
                            <path d="M12 23.403V23.39 10.389L11.88 10.3h-.01L9.14 8.28C7.47 7.04 5.09 7.1 3.61 8.56 2.62 9.54 2 10.9 2 12.41v3.602L12 23.403zM38 23.39v.013l10-7.391V12.41c0-1.49-.6-2.85-1.58-3.83-1.46-1.457-3.765-1.628-5.424-.403L38.12 10.3 38 10.389V23.39zM14 24.868l10.406 7.692c.353.261.836.261 1.189 0L36 24.868V11.867L25 20l-11-8.133V24.868zM38 25.889V41c0 .552.448 1 1 1h6.5c1.381 0 2.5-1.119 2.5-2.5V18.497L38 25.889zM12 25.889L2 18.497V39.5C2 40.881 3.119 42 4.5 42H11c.552 0 1-.448 1-1V25.889z"></path>
                        </svg>
                        <span className="text-slate-100 text-xl group-hover:text-purple-300 transition-colors">kacperjaroszewski06@gmail.com</span>
                    </a>
                </div>
            </div>
        </div>
